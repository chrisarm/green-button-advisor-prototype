<template>
  <div id="app">
    ...
    <div v-if="currentPage === 'plans'">
      ...
      <p>Select Two (2) Plans below to compare the price difference for your usage. You'll be able to upload your GreenButton usage data on the next screen.</p>
      <div class="plans-container">
        ...
        <div class="plan selected">
          <h3>EV-TOU-5</h3>
          <p>Special plan for electric vehicle owners with lower rates during off-peak hours.</p>
        </div>
    ...
    <div v-else>
      ...
      <div v-if="!overallSummary && !processing">
        <h3>Compare the selected plans</h3>
	<p>Click the 'Try Sample Data' to get a price comparison.</p>
	<p>When you are ready, you can also upload your GreenButton usage data to see the estimated cost difference for your home.</p>
