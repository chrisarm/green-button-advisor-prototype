<template>
  <div id="app">
    ...
    <div v-if="!overallSummary && !processing">
      <h4>Upload SDGE GreenButton Data</h4>
    ...
    <div class="disclaimer">
      ...
      <p>We're working make this better able to handle up to 12 months for the most accurate analysis. So some charts may look weird until we finish that effort.</p>
